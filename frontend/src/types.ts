 ...
 *
 * These interfaces describe the JSON shapes the backend sends so the rest of
 * the frontend gets autocomplete and compile-time checks. They must be kept in
 * sync with `backend/app/models/domain.py`.
 */
