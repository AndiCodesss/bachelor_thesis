...
- **Algorithm**: Feedforward neural network with two hidden layers
...
Full error dump: `backend/data/misclassified.json` (generated by the error-analysis pipeline and included in the repository).
...
All results can be reproduced from the labelled dataset (`backend/data/training_data.jsonl`), which is included in the repository. From the repository root, run:
