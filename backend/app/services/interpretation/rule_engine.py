...
class RuleBasedTradeInterpreter:
    ...
    def _parse_compiled(
        ...
        *,
        ...
        # --- Stop adjustment on an already-open position. Intentionally placed
        # AFTER pending-entry completion so a stitched stop price still completes
        # a just-announced entry rather than being misread as a stop move. ---
