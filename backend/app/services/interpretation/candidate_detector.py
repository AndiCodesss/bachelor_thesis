...
def assess_trade_candidate(
    *,
    ...
    # A continuation fragment ("and versus 800") is only evidence if it follows
    # prior seed context or the classifier already shows a weak action signal --
    # hence the low 0.22 floor: standalone, a connector word means nothing.
