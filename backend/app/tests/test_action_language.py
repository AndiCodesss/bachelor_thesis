...
def test_explicit_i_did_enter_short() -> None:
    # "enter short" is an explicit short entry and must not fall through to the
    # side-neutral branch (which would mis-tag it as a long).
